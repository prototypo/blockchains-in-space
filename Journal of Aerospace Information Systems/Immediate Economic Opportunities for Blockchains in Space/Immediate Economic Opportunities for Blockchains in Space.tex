...
% End author-specific packages
 ...
 \title{Immediate Economic Opportunities for Blockchains in Space}

% \textbf{TODO}: Uncertain author list
 \author{
  David Hyland-Wood%
...
\begin{abstract}
\textbf{TODO}: A survey paper covering the existing blockchains in space trials (e.g. SpaceChain, Blockstream), the cybersecurity work from the ICSSC and SDLT papers, Mandl?s spacecraft tasking approach using smart contracts, and Lobao?s idea for an after-market economy for spacecraft in (e.g.) geosynchronous graveyard orbits.
\end{abstract}

\section*{Nomenclature}

\textbf{TODO}: Revisit and probably remove.
...
\textbf{TODO}: Remove material unrelated to this paper. Retain and focus on other companies' fielded or proposed economic opportunities.
...
\subsection{Spacecraft Cybersecurity}
