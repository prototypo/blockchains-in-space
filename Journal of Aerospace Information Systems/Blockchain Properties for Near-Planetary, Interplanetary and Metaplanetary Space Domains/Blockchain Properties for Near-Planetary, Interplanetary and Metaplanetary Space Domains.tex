...
\item as a means to coordinate the fulfillment \todo{spell check fulfilment or fulfillment} of a desired operation carried out by many individual spacecraft\cite{mandl_bitcoin_2017}
\end{itemize}
